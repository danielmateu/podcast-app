...
export const Podcast = () => {
    ...
    return (
        <li className='animate__animated animate__fadeIn  flex flex-col items-center shadow-xl hover:shadow-md transition-all rounded-xl py-2 px-4 relative my-12'>
